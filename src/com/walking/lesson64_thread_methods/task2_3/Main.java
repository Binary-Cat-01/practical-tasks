...
import com.walking.lesson64_thread_methods.task2_3.model.TimePrintingWithTracking;
...
public class Main {
    public static void main(String[] args) {
        ...
        var timePrintingWithTracking = new TimePrintingWithTracking(Duration.ofMillis(100),
                DateTimeFormatter.ofPattern("KK:mm:ss:SSS"), Thread.currentThread());

        Thread timePrinter = new Thread(timePrintingWithTracking, "timePrinter");
